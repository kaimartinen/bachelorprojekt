  ...
  _p2(2.0)
{
  ...
  _end = {{norm[0] * (-1) * (0.2 + line.length()) + _line.getStart()[0], norm[1] * 0.2 + _line.getStart()[1]}};
  _p_point = {{norm[0] * (-1) * (line.length() / 2) + _line.getStart()[0], norm[1] * 0.2 + _line.getStart()[1]}};
}
